...
export default class Stage extends cc.Component {
    ...
    onLoad() {
        ...
        this.groundOrigin.x = this.groundLayer.position.x;
        this.groundOrigin.y = this.groundLayer.position.y;
    }

    public init(jumpScene1: JumpScene) {
        this.jumpScene = jumpScene1;
    }
    ...
    public reset() {
        ...
        this.groundLayer.position.x = this.groundOrigin.x;
        this.groundLayer.position.y = this.groundOrigin.y;
        this.g.clear();
        ...
        this.player.node.position.x = center * this.gridWidth + this.gridWidth / 2;
        this.player.node.position.y = 0;
